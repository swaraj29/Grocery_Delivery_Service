  ...
  return (
    <div  className='p-4'>
      <form className='m-auto w-full max-w-md shadow flex flex-col p-3 bg-white' onSubmit={handleSubmit}>
        ...
        <input type={"text"} name='name'className='bg-slate-200 p-2 my-1' onChange={handleOnChange} value={data.name}/>

        <label htmlFor='categroy'>Category</label>

        <select className='bg-slate-200 p-2 my-1' id='category'name='category' onChange={handleOnChange} value={data.category}>
